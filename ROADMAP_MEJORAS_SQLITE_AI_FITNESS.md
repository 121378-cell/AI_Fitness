...
10. Refactor inicial de `` por módulos.
...
- [x] Fase 0 / Task 3: validación central de configuración IA implementada y conectada en ``.
- [x] Verificación de sistema tras cambios: `make ci-check` en verde en este entorno.
- [x] Precondición aplicada: eliminación total de componentes y dependencias del proveedor retirado.
